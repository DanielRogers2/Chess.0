...
{
    uint8_t row = pindex / 8;
    uint8_t col = pindex % 8;
     ...
     * 0  1  2  3  4  5  6  7
     */
    //The main diagonal is 7, and goes from a1 to h8
    diagonal_indexes[0] = row + 7 - col;
     ...
     * 0  1  2  3  4  5  6  7
     */
    //The main diagonal is 7, and goes from a8 to h1
    diagonal_indexes[1] = row + col;
}
